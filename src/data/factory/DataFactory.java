...
public abstract class DataFactory {
    public static DataSeries parseData(MetaData meta_data, ArrayList<String[]> input)
        ...
        try {
            ...
            throw new ClassNotFoundException("Error [DataFactory]: Could not load given Class:" + className);
        } catch (InstantiationException | IllegalAccessException e) {
            throw new IllegalAccessException("Error [DataFactory]: Could not load given Data.");
        }
    }
